...
HD_PWD='C:/Workplace/SUSTech-EE332-Digital-System-Designing-Laboratory/Lab02/ex4_three_digit_decimal_counter/ex4_three_digit_decimal_counter.runs/synth_1'
cd "$HD_PWD"
